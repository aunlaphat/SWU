...
@NgModule({
    declarations: [
    OfferedCourseReportComponent,
    CanceledCourseReportComponent,
    EnrollmentListReportComponent,
    CourseEnrollmentReportComponent,
    CoursePaymentReportComponent,
    EnrollmentAndPaymentReportComponent,
    DepartmentIncomeReportComponent
  ],
    imports: [
        CommonModule,
        ReportRoutingModule,
