...
@Slf4j
public class EnrollmentAndPaymentExportProvider extends InterfaceNativeGenerateRowData<ReportEnrollmentAndPaymentData>{
	@NonNull
    ...
    private List<ReportEnrollmentAndPaymentData> rawData;
    private ReportEnrollmentAndPaymentData Total;

    @Override
    public DataResponse<ReportEnrollmentAndPaymentData> getData() throws Exception {
        ...
        return DataResponse.<ReportEnrollmentAndPaymentData>builder()
//            .datas(rawData)
