 ...
 */
@Data
public class TmpFinanceImportDetailData extends PageableCommon implements Serializable {
	
	private static final long serialVersionUID = -5288768938272427424L;

	@Schema(description = "PK")
	private Long detailId;
	
	@Schema(description = "Fk (tmp_finance_import_log)")
