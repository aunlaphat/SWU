...
import com.arg.swu.services.cert.CMSProcessableInputStream;
import com.arg.swu.services.cert.CertificateVerificationException;
import com.arg.swu.services.cert.CertificateVerifier;
...
public final class ShowSignature {
    ...
    public PDDocument validateCertificate(File infile) throws IOException
    {
    ...
    public void showSignature(String[] args) throws IOException,
                                                     GeneralSecurityException,
                                                     TSPException,
                                                     CertificateVerificationException
    {
